...
<head>
    ...
    <title>OldNew Gen Gaming Center Cart Details</title>
    <!--Bootstrap CSS Link -->
...
<!-- Third Child -->
<div class="bd-light">
  <h3 class="text-center">Cart Information For Gaming Center</h3>
    ...
    <div class="row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="submit" value="Update Cart" class="bg-secondary px-3 py-2 border-0 mx-3" name="update_cart">
                        <!-- <button class="bg-secondary px-3 py-2 border-0 mx-3">Remove</button> -->
                        <input type="submit" value="Remove Cart" class="bg-secondary px-3 py-2 border-0 mx-3" name="remove_cart">
                    </td>
                </tr>
        ...
        <?php
         ...
         if($result_count>0){
            ...
            <input type='submit' value='Continue Shopping' class='bg-secondary px-3 py-2 border-0 mx-3' name='continue_shopping'>
            <button class='bg-dark text-light p-3 py-2 border-0'><a href='./users_area/checkout.php' class='text-light text-decoration-none'>Checkout</a></button>";
         }else{
